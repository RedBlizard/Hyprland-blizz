...
show_main_menu() {
    while true; do
        main_menu="Hyprland\nWaybar configs\nWaybar styles\nSwww options"
        selected_config=$(echo -e "$main_menu" | yad --title="Settings" --text="" --geometry=400x390+800+600 --width=400 --height=390 --list --column="Settings" --separator='\n' --borders=9 -timeout=5 --button=Close --center --image="$logo_path")
...
launch_hyprland_settings() {
    while true; do
        ...
        selected_submenu=$(echo -e "$submenu" | yad --title="Hyprland Settings" --text="" --geometry=400x390+800+600 --width=400 --height=390 --list --column="Settings" --separator='\n' --borders=9 -timeout=5 --button=Close --center --image="$logo_path") 
...
launch_waybar_configs() {
    while true; do
        ...
        selected_submenu=$(echo -e "$submenu" | yad --title="Waybar Configs" --text="" --geometry=400x390+800+600 --width=400 --height=390 --list --column="Configs" --separator='\n' --borders=9 -timeout=5 --button=Close --center --image="$logo_path")
...
launch_waybar_styles() {
    while true; do
        ...
        selected_submenu=$(echo -e "$submenu" | yad --title="Waybar Styles" --text="" --geometry=400x390+800+600 --width=400 --height=390 --list --column="Styles" --separator='\n' --borders=9 -timeout=5 --button=Close --center --image="$logo_path")
...
launch_swww_options() {
    while true; do
        ...
        selected_submenu=$(echo -e "$submenu" | yad --title="Swww Options" --text="" --geometry=400x390+800+600 --width=400 --height=390 --list --column="Options" --separator='\n' --borders=9 -timeout=5 --button=Close --center --image="$logo_path")
