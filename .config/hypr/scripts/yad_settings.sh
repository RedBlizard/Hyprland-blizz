...
show_main_menu() {
    while true; do
        main_menu="Hyprland\nWaybar configs\nWaybar styles\nSwww options"
        selected_config=$(echo -e "$main_menu" | yad --title="Settings" --text="" --width=1000 --height=395 --list --column="Settings" --separator='\n' --borders=9 -timeout=5 --button=Exit --center --image="$logo_path")
...
launch_hyprland_settings() {
    while true; do
        ...
        selected_submenu=$(echo -e "$submenu" | yad --title="Hyprland Settings" --text="" --width=1000 --height=395 --list --column="Settings" --separator='\n' --borders=9 -timeout=5 --button=Exit --center --image="$logo_path") 
...
launch_waybar_configs() {
    while true; do
        ...
        selected_submenu=$(echo -e "$submenu" | yad --title="Waybar Configs" --text="" --width=1000 --height=395 --list --column="Configs" --separator='\n' --borders=9 -timeout=5 --button=Exit --center --image="$logo_path")
...
launch_waybar_styles() {
    while true; do
        ...
        selected_submenu=$(echo -e "$submenu" | yad --title="Waybar Styles" --text="" --width=1000 --height=395 --list --column="Styles" --separator='\n' --borders=9 -timeout=5 --button=Exit --center --image="$logo_path")
...
launch_swww_options() {
    while true; do
        ...
        selected_submenu=$(echo -e "$submenu" | yad --title="Swww Options" --text="" --width=1000 --height=395 --list --column="Options" --separator='\n' --borders=9 -timeout=5 --button=Exit --center --image="$logo_path")
