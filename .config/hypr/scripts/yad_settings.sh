...
show_main_menu() {
    while true; do
        main_menu="Hyprland\nWaybar configs\nWaybar styles\nSwww options"
        selected_config=$(echo -e "$main_menu" | yad --title="Settings" --text="" --geometry=905x405+800+600 --width=905 --height=405 --fixed --list --column="Settings" --separator='\n' --borders=9 -timeout=5 --button=Close --center --image="$logo_path")
...
launch_hyprland_settings() {
    while true; do
        ...
        selected_submenu=$(echo -e "$submenu" | yad --title="Hyprland Settings" --text="" --geometry=905x405+800+600 --width=905 --height=405 --fixed --list --column="Settings" --separator='\n' --borders=9 -timeout=5 --button=Close --center --image="$logo_path") 
...
launch_waybar_configs() {
    while true; do
        ...
        selected_submenu=$(echo -e "$submenu" | yad --title="Waybar Configs" --text="" --geometry=905x405+800+600 --width=905 --height=405 --fixed --list --column="Configs" --separator='\n' --borders=9 -timeout=5 --button=Close --center --image="$logo_path")
...
launch_waybar_styles() {
    while true; do
        ...
        selected_submenu=$(echo -e "$submenu" | yad --title="Waybar Styles" --text="" --geometry=905x405+800+600 --width=905 --height=405 --fixed --list --column="Styles" --separator='\n' --borders=9 -timeout=5 --button=Close --center --image="$logo_path")
...
launch_swww_options() {
    while true; do
        ...
        selected_submenu=$(echo -e "$submenu" | yad --title="Swww Options" --text="" --geometry=900x405+800+600 --width=900 --height=405 --fixed --list --column="Options" --separator='\n' --borders=9 -timeout=5 --button=Close --center --image="$logo_path")
