...
There are updates available for the dotfiles.
Run the Hyprland welcome app and apply the update now."

    elif [ "$urgency" = "normal" ]; then
        # Format the message for normal notifications
        local formatted_message="Updates are available for the dotfiles.
Please run the Hyprland welcome app and apply the update."
