...
echo "# █▀▄▀█ Monitors - Clean & Optimized" > ~/.config/hypr/conf/monitor.conf
echo "# This configuration is structured for readability and maintainability" >> ~/.config/hypr/conf/monitor.conf
...
echo "# █▀▄▀█ Env Var - Clean & Optimized" >> ~/.config/hypr/conf/workspaces.conf
echo "# This configuration is structured for readability and maintainability" >> ~/.config/hypr/conf/workspaces.conf
