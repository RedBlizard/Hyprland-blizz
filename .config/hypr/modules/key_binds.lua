...
hl.bind(mainMod .. " + SHIFT + V", hl.dsp.exec_cmd("alacritty --class=nvim nvim"))
...
hl.bind(mainMod .. " + SHIFT + K", hl.dsp.exec_cmd("alacritty --class=virt-manager virt-manager"))
hl.bind(mainMod .. " + SHIFT + N", hl.dsp.exec_cmd("$HOME/.config/hypr/scripts/waytrogen.sh"))
hl.bind(mainMod .. " + SHIFT + O", hl.dsp.exec_cmd("obs"))
hl.bind(mainMod .. " + SHIFT + C", hl.dsp.exec_cmd("guvcview"))
hl.bind(mainMod .. " + SHIFT + P", hl.dsp.exec_cmd("alacritty --class=pacseek pacseek"))
...
---- Hypr Welcome Float Toggle ----
hl.bind(mainMod .. " + F", hl.dsp.exec_cmd("$HOME/.config/hypr/scripts/toggle_float.sh"))
