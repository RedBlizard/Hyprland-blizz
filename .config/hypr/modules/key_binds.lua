...
hl.bind(mainMod .. " + SHIFT + V", hl.dsp.exec_cmd("code-oss"))
hl.bind(mainMod .. " + SHIFT + M", hl.dsp.exec_cmd("brave --app=https://outlook.com"))
hl.bind(mainMod .. " + O", hl.dsp.exec_cmd("helium-browser --app=http://localhost:9000"))
hl.bind(mainMod .. " + V", hl.dsp.exec_cmd("kitty --class=virt-manager virt-manager"))
...
hl.bind(mainMod .. " + SHIFT + H", hl.dsp.exec_cmd("hyprmod"))
...
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd("$HOME/.config/hypr/scripts/wofi-emoji"))

---- Clipboard & Radio ----
hl.bind(mainMod .. " + ALT + H", hl.dsp.exec_cmd("$HOME/.config/hypr/scripts/cliphist-history.sh"))
hl.bind(mainMod .. " + ALT + C", hl.dsp.exec_cmd("$HOME/.config/hypr/scripts/cliphist.sh"))
hl.bind("CTRL + B", hl.dsp.exec_cmd("$HOME/.config/wofi/wofi-beats/wofi-beats -theme ~/.config/wofi/wofi-beats/style.css"))
...
---- Set Kvantum Root Theme ----
hl.bind(mainMod .. " + SHIFT + K", hl.dsp.exec_cmd("$HOME/.config/hypr/scripts/set_root_kvantum_wrapper.sh"))
