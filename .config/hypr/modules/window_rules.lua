...
hl.window_rule({ match = { class = exact_match("helium-browser") }, workspace = 6 })

hl.window_rule({ match = { class = exact_match("virt-manager") }, workspace = 7 })

hl.window_rule({ match = { class = exact_match("waytrogen") }, workspace = 8 })
...
hl.window_rule({ match = { class = exact_match("brave-browser") }, opacity = "0.90 0.90" })

hl.window_rule({ match = { class = exact_match("geany") }, opacity = "0.80 0.70" })
hl.window_rule({ match = { class = exact_match("thunar") }, opacity = "0.80 0.70" })
hl.window_rule({ match = { class = exact_match("file-roller") }, opacity = "0.80 0.70" })
hl.window_rule({ match = { class = exact_match("nwg-look") }, opacity = "0.80 0.70" })
hl.window_rule({ match = { class = exact_match("qt6ct") }, opacity = "0.80 0.70" })
hl.window_rule({ match = { class = exact_match("pavucontrol") }, opacity = "0.80 0.70" })
hl.window_rule({ match = { class = exact_match("yad") }, opacity = "0.80 0.70" })
hl.window_rule({ match = { title = exact_match("nvim") }, opacity = "0.80 0.70" })
hl.window_rule({ match = { class = exact_match("code-oss") }, opacity = "0.80 0.70" })
hl.window_rule({ match = { class = exact_match("hypr-welcome") }, opacity = "0.80 0.70" })
hl.window_rule({ match = { class = exact_match("dolphin") }, opacity = "0.80 0.70" })
