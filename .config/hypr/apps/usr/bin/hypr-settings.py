...
class MyApp(Adw.Application):
    ...
    configFolderName = "hypr-settings" # config folder name
    ...
    def __init__(self, **kwargs):
        super().__init__(application_id='com.hypr.settings', flags=Gio.ApplicationFlags.DEFAULT_FLAGS)
    ...
    def do_activate(self):
        ...
        win.present()
        print (":: Welcome to Hypr Settings App")
