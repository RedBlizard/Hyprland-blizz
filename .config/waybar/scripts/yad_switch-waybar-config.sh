...
selected_config=$(printf "%s\n" "${WAYBAR_CONFIGS[@]}" | yad --list --column="Configuration" --separator="" --no-headers --title="Choose Configuration" --text="" --center --button=Close --geometry=400x390+800+600 --width=400 --height=390 --image="$logo_path")
